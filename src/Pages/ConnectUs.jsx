      ...
      <div className="flex justify-between items-center">
        <div className="w-1/3">
          ...
          <p className="text-gray-600 mt-5">
            ...
            about our properties, want to schedule a viewing, or simply want to
            share your feedback, we are here to assist you every step of the
            way. There are several ways to get in touch with us
          </p>
        </div>
        <div className="w-2/3">
          <img
