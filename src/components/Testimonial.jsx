      ...
      <section className="my-8 bg-gray-800 text-gray-100 mt-10 lg:mt-24">
        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
          ...
          <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-gray-300">
            Our team of experts is dedicated to ensuring that you find the
            property of your dreams without compromising on quality or
            affordability.
          </p>
          <div className="flex justify-center space-x-3">
            ...
            />
            <div>
              <p className="leading-tight">Harun Tahid</p>
